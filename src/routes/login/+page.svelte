...
<div class="flex w-fulll min-h-screen items-center justify-center">
  <div class="card card-border card-lg bg-base-100 w-96 shadow-sm">
    <form class="card-body space-y-3" use:enhance>
      ...
      <FormField {form} field="emailOrUsername" label="Email" type="text" autocomplete="email" />
      <FormField {form} field="password" label="Senha" type="password" autocomplete="current-password" />
      <div class="card-actions">
        <Button type="submit" class="btn-primary btn-block" loading={$delayed}>Entrar</Button>
